 ...
 * @author macpro13
 */
public class AddScoreView extends javax.swing.JFrame {

    /**
     * Creates new form AddScoreView
     */
    public AddScoreView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddScoreView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddScoreView().setVisible(true);
            }
        });
    }
